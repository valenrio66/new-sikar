								...
								<ul class=" list-group">
									<li class="list-group-item rounded-0">
										<div class="custom-control custom-checkbox">
											<input class="custom-control-input" name="gejala[]" value="G1" id="G1" type="checkbox">
											<label class="cursor-pointer font-bold d-block custom-control-label" for="G1">Bercak - Bercak Putih Bersudut</label>
										</div>
									</li>
